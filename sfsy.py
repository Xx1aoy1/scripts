...
inviteId = ['C8FC450B0C1541A8B8E3CE76BFBD043B','803FAD0323C14C7EA1BE1B960922C21A']
...
class RUN:
    def __init__(self, info, index):
        ...
        self.login_res = self.login(unquote(url))
                ...
                if self.title =='领任意生活特权福利':
                    ...
                    if response.get('success') == True:
                        ...
                        for goods in goodsList:
                            ...
                            if currentStore == 0:
                                continue
                            exchangeTime = goods['exchangeTime']
                            exchangeTimesLimit = goods['exchangeTimesLimit']
                            if exchangeTime == exchangeTimesLimit:
                                continue
...
✨✨✨ ✨✨✨
    ...
    if ENV_NAME in os.environ:
        ...
        print("调用拉菲变量")
        tokens = re.split("&",os.environ.get("sfsyUrl"))
    else:
        tokens =['']
